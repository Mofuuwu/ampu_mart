...
<section class="my-5 px-[5%] flex justify-center items-center">
    <div class="min-w-[80%] relative">
        ...
        <div class="absolute text-center left-[50%] top-[50%] transform -translate-x-1/2 -translate-y-1/2 w-full px-[10%]">
            <p class="font-semibold text-5xl max-[1100px]:text-4xl max-[870px]:text-3xl max-[700px]:text-2xl max-[550px]:text-xl max-[450px]:text-sm text-white mb-4 font-sour-gummy">Sistem Toko Online Universitas Amikom Purwokerto Mudah Dan Praktis</p>
            <a href="/jelajahi-produk" class="font-bold max-[1100]:text-lg max-[700px]:text-sm text-blue-300 shadow-md hover:text-lightblue hover:bg-slate-200 transition-colors bg-darkblue md:px-5 md:py-2 px-3 py-1 md:rounded-[14px] rounded-lg  font-sour-gummy">Jelajahi Produk > </a>
        </div>
    </div>
</section>
...
<section class="my-10 md:my-36">
    <div class="w-full bg-lightblue flex justify-around md:py-8 py-4 shadow-md">
        <div class="flex items-center gap-4 max-[450px]:gap-2 max-[450px]:flex-col">
            <div class="text-white">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-16 max-[700px]:size-14 max-[600px]:size-12 max-[450px]:size-10">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m20.25 7.5-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125Z" />
                </svg>
            </div>
            <div class="max-[450px]:flex-col max-[450px]:flex max-[450px]:items-center">
                <p class="text-white text-4xl font-semibold font-sour-gummy max-[700px]:text-2xl max-[600px]:text-xl max-[450px]:text-sm">100+</p>
                <p class="text-white text-xl font-bold font-sour-gummy max-[700px]:text-md max-[600px]:text-sm">Produk</p>
            </div>
        </div>
        <div class="flex items-center gap-4 max-[450px]:gap-2 max-[450px]:flex-col">
            <div class="text-white">
            ...
            <div class="max-[450px]:flex-col max-[450px]:flex max-[450px]:items-center">
                <p class="text-white text-4xl font-semibold font-sour-gummy max-[700px]:text-2xl max-[600px]:text-xl max-[450px]:text-sm">300+</p>
                <p class="text-white text-xl font-bold font-sour-gummy max-[700px]:text-md max-[600px]:text-sm">Produk Terjual</p>
            </div>
        </div>
        <div class="flex items-center gap-4 max-[450px]:gap-2 max-[450px]:flex-col">
            <div class="text-white">
            ...
            <div class="max-[450px]:flex-col max-[450px]:flex max-[450px]:items-center">
                <p class="text-white text-4xl font-semibold font-sour-gummy max-[700px]:text-2xl max-[600px]:text-xl max-[450px]:text-sm">20+</p>
                <p class="text-white text-xl font-bold font-sour-gummy max-[700px]:text-md max-[600px]:text-sm">User Aktif</p>
            </div>
        </div>
    </div>
</section>
