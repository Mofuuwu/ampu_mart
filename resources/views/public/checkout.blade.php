            ...
            <div class=" bg-gray-200 p-5 rounded-[12px]">
                ...
                <div class="mb-10">
                    ...
                    <div class="flex items-center gap-2 mt-1">
                        <input type="radio" id="pay-on-site-btn" name="payment-option" value="pay_on_site" class="h-5 w-5 text-lightblue border-slate-400 border-2 focus:ring-0 hidden">
                    ...
                    <div class="flex items-center gap-2 mt-1">
                        <input type="radio" id="use-balance-btn" name="payment-option" value="use_balance" class="h-5 w-5 text-lightblue border-slate-400 border-2 focus:ring-0 hidden">
